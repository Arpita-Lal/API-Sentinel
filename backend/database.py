    ...
    with SessionLocal() as db:
        ...
        db.add_all(
            [
                ...
                ApiInventory(endpoint="/api/security/bola-alerts", category="known", status="known", notes="BOLA alert feed for security operations"),
                ApiInventory(endpoint="/api/security/user/{user_id}/access-map", category="known", status="known", notes="Learned user-object access graph"),
            ]
        )

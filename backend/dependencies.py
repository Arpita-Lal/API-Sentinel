...
from backend.repositories import AlertRepository, BolaAlertRepository, BolaObservationRepository, InventoryRepository, OrderRepository, PaymentRepository, RequestLogRepository, UserRepository
...
def get_bola_alert_repository(db: Annotated[Session, Depends(get_db)]) -> BolaAlertRepository:
    return BolaAlertRepository(db)


def get_bola_observation_repository(db: Annotated[Session, Depends(get_db)]) -> BolaObservationRepository:
    return BolaObservationRepository(db)

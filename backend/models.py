...
class BolaObservation(Base):
    """Normalized BOLA telemetry used to learn access patterns."""

    __tablename__ = "bola_observations"
...
class BolaAlert(Base):
    """Persistent alert row dedicated to BOLA detections."""

    __tablename__ = "bola_alerts"
